...
// desplaza 6 horas según dónde se lea. Copia
// idéntica en src/lib/lineupSchedule.ts (app y admin no comparten módulos;
// tests/unit/lineupSchedule.test.mts vigila que no se desincronicen).
//
